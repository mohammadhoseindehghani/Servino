...
public class CommentAppService(ICommentService commentService,IRequestService requestService,
    ISuggestionService suggestionService, ILogger<CommentAppService> logger) : ICommentAppService
{
    ...
    {
        return await commentService.GetAllAsync(pagination, ct);
    }
    ...
    {
        return await commentService.GetApprovedByExpertIdAsync(expertId, pagination, ct);
    }
